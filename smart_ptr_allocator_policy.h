...
template <typename T1, size_t N1, typename PolicyT1 = uP_allocator_policy<T1>,
          typename TraitsT1 = object_traits<T1> >
struct uP_smart_ptr_allocator_policy {
 ...
 private:
  ...
  allocator<T2, N2, PolicyT2, TraitsT2> const& _allocator() {
    static allocator<T2, N2, PolicyT2, TraitsT2> _ptr_allocator =
        allocator<T2, N2, PolicyT2, TraitsT2>();
    return _ptr_allocator;
  }
};
